...
WINWIDTH = 960 # width of the program's window, in pixels # REQUIREMENT 1
...
CAMERASLACKX = 100     # REQUIREMENT 2 ADDED
CAMERASLACKY = 80     # REQUIREMENT 2 ADDED
MOVERATE = 9         # how fast the player moves
BOUNCERATE = 6       # how fast the player bounces (large is slower)
BOUNCEHEIGHT = 30    # how high the player bounces
STARTSIZE = 25       # how big the player starts off
WINSIZE = 300        # how big the player needs to be to win
LOSTSIZE = 50        # REQUIREMENT 4 ADDING LOSTSIZE VARIABLE
...
def main():
    global FPSCLOCK, DISPLAYSURF, BASICFONT, L_SQUIR_IMG, R_SQUIR_IMG, GRASSIMAGES, V_L_SQUIR_IMG, V_R_SQUIR_IMG # Requirement 3
    ...
    V_L_SQUIR_IMG = pygame.transform.flip(L_SQUIR_IMG, False, True) # Requirement 3
    V_R_SQUIR_IMG = pygame.transform.flip(L_SQUIR_IMG, True, True)  # Requirement 3
    GRASSIMAGES = []
    for i in range(1, 5):
...
def runGame():
    ...
    while True: # main game loop
        ...
        # if (camerax + HALF_WINWIDTH) - playerCenterx > CAMERASLACK:  # REQUIREMENT 2
            ...
            for i in range(len(squirrelObjs)-1, -1, -1):
                ...
                if 'rect' in sqObj and playerObj['rect'].colliderect(sqObj['rect']):
                    ...
                    if sqObj['width'] * sqObj['height'] <= playerObj['size']**2:
                        ...
                        if sqObj['width'] * sqObj['height'] > playerObj['size'] ** 2:  # REQUIREMENT 4
                            # player is smaller and is eaten by the squirrel
                            playerObj['size'] -= int((sqObj['width'] * sqObj['height']) ** 0.2) + 1
                            del squirrelObjs[i]
                        ...
                        if playerObj['health'] == 0 or playerObj['size'] < LOSTSIZE:  # REQUIREMENT 4
...
def makeNewSquirrel(camerax, cameray):
    ...
    sq['dir'] = random.choice(['True', 'False'])  # Requirement 3

    # if sq['movex'] < 0: # squirrel is facing left  # Requirement 3
    #     sq['surface'] = pygame.transform.scale(L_SQUIR_IMG, (sq['width'], sq['height']))
    # else: # squirrel is facing right
    #     sq['surface'] = pygame.transform.scale(R_SQUIR_IMG, (sq['width'], sq['height']))

    if sq['dir'] == 'True':  # Requirement 3
    ...
    if sq['movex'] < 0:  # squirrel is facing left
        if sq['dir'] == 'True':
            sq['surface'] = pygame.transform.scale(V_L_SQUIR_IMG, (sq['width'], sq['height']))
        else:
            sq['surface'] = pygame.transform.scale(L_SQUIR_IMG, (sq['width'], sq['height']))
    else: # squirrel is facing right
        if sq['dir'] == 'True':
            sq['surface'] = pygame.transform.scale(V_R_SQUIR_IMG, (sq['width'], sq['height']))
        else:
            sq['surface'] = pygame.transform.scale(R_SQUIR_IMG, (sq['width'], sq['height']))

    sq['bounce'] = 0
    sq['bouncerate'] = random.randint(10, 18)
    # sq['bounceheight'] = random.randint(10, 50) # Requirement 3 REMOVED
    return sq

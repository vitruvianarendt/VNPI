...
# GRASSCOLOR = (24, 255, 0)
GRASSCOLOR = (0, 128, 0)  # REQUIREMENT #10 MODIFIED

WHITE = (255, 255, 255)
RED = (255, 0, 0)

# CAMERASLACK = 90     # how far from the center the squirrel moves before moving the camera
CAMERASLACKX = 100     # REQUIREMENT #7 ADDED
CAMERASLACKY = 80     # REQUIREMENT #7 ADDED

# MOVERATE = 9         # how fast the player moves
# BOUNCERATE = 6       # how fast the player bounces (large is slower)
MOVERATE = 10        # REQUIREMENT #2 MODIFIED
BOUNCERATE = 5       # REQUIREMENT #2 MODIFIED
BOUNCEHEIGHT = 30    # how high the player bounces
STARTSIZE = 25       # how big the player starts off
WINSIZE = 300        # how big the player needs to be to win
# INVULNTIME = 2       # how long the player is invulnerable after being hit in seconds
INVULNTIME = 5       # REQUIREMENT #8 MODIFIED
...
SQUIRRELMINSPEED = 5 # slowest squirrel speed # REQUIREMENT 9 MODIFIED
SQUIRRELMAXSPEED = 10 # fastest squirrel speed # REQUIREMENT 9 MODIFIED
...
def main():
    ...
    pygame.display.set_icon(pygame.image.load('gameicon.png')) # REQUIREMENT #4
    ...
    GRASSIMAGES.append(pygame.image.load('rock.png'))  # REQUIREMENT #10 ADDED
    GRASSIMAGES.append(pygame.image.load('flowers.png'))  # REQUIREMENT #10 ADDED
    while True:
        runGame()
...
def runGame():
    ...
    for i in range(3): # REQUIREMENT 5 ADDED
    ...
    while True: # main game loop
        ...
        for sObj in squirrelObjs:
            ...
            # if random.randint(0, 99) < DIRCHANGEFREQ: # REQUIREMENT #6
            if random.randint(1, 99) < DIRCHANGEFREQ:  # REQUIREMENT #6 MODIFIED
        ...
        # if (camerax + HALF_WINWIDTH) - playerCenterx > CAMERASLACK: # REQUIREMENT #7 MODIFIED
        ...
        # flashIsOn = round(time.time(), 1) * 10 % 2 == 1 # REQUIREMENT #8 MODIFIED
        flashIsOn = round(time.time(), 1) * 100 % 3 == 1
